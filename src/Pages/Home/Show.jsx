...
export const Show = () => {
  ...
  return (
    <div className="min-h-screen w-screen">
      {/* Top Navigation */}
      <div className="h-[70px] w-full  bg-gradient-to-bl from-[#000620] to-[#0002] flex gap-3 justify-center items-center px-2">
        ...
        {Object.entries(tabData).map(([key, { label }]) => (
          <button
            ...
            className={`py-2 px-5 rounded-full font-medium transition-colors duration-200 
              ${activeTab === key ? "bg-gradient-to-r from-[#000325] to-[#fff] text-white border-b-2 border-white" : "bg-gradient-to-r from-[#0d0a2b] to-[#000] border border-white text-white hover:bg-green-600"}`}
          >
            {label}
          </button>
        ))}
